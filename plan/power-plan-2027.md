...
| **Nitecore NU43** | Off (in pack/pulk) | Tent pitch · cook · melt · chores · **~1 h** low/mid + red in tent | Off | **~1 h** | **~3–7%** (~0.4 Wh) | **~18%** | Every **7–10 nights** |
| **Suunto Vertical 2** | **GPS route on** · map on wrist · **~8 h** ski · wrist-raise · HR | End/pause activity · camp time · optional LED | On wrist | **~8 h** GPS + **~15–20 min** screen | **~12–18%** (~0.3–0.4 Wh) | **~16%** | Every **2 nights** → ~60–70% |
| **Fairbuds XL** | Off | Camp audio · **30–60 min** · ANC off | Off | **~0.5–1 h** | **~2–4%** (~0.15 Wh) | **~7%** | Every **7 nights** |
...
| Order | Task | Power |
|-------|------|-------|
| 1 | Tent up · melt start | NU43 **low/mid** ~20–30 min · **CO detector ON** — magnetic · face height |
| 2 | **Boots off · booties** | — |
...
| **Tent** | Short OsmAnd / photos / msgs · **~8–20 min** | **~0.45–0.6 Wh** — **~21%** of day budget |
| Brightness | **Low** + short timeout | Cold + screen = fast drain |
| Photos | **Few** — review/delete duds **in tent** · keep sessions short | Don’t burn ski-day battery on gallery |
| Charge target | **★ / hut only** — full overnight | ~**1.5–2.5%/day** of ~37 Wh cell · **do not** top from Zolo mid-leg |

**Specs:** **~358 g** · **10 000 mAh** typ. / **9000** rated (~**33–37 Wh**) · **18 W** USB-C · IP68/IP69K · Android 12 — [Ulefone Power Armor 14 Pro](https://www.ulefone.com/products/power-armor-14-pro).

**Zolo rule:** One 0→70% Armor fill pulls ~**25–35 Wh** (~**half** cold-effective bank). Treat phone as **resupply-only** charge.
...
**Owned:** [bol.com portable 3-in-1](https://www.bol.com/nl/nl/p/gasdetector-koolmonoxidedetector-draagbare-koolmonoxidemelder-temperatuurweergave-vochtigheidsweergave-magnetische-adsorptie/9300000256771676/) — CO + temperature + humidity · magnetic back · **USB-C** · ~**700–1000 mAh** (~**3 Wh**) · ~**58 g**.
...
**Zolo → Armor:** ~**1.2–1.4×** full phone charges warm (~**1.2–1.3×** cold) — not 2×. Prefer wall fills so bank stays for Suunto.

---

## Charge calendar (7-day leg)

**Rule:** Only charge from the bank after **15+ min** warm against body. **One device per night** — Suunto wins ties. **Armor stays off the calendar** unless &lt;30% before a long stretch with no ★.
...
| **D5** | **Suunto** → ~60% | |
| **D6** | **NU43** or **Fairbuds** | Or rest bank — **not** Armor |
...
**Time budget:** ~**3–4 h** unattended overnight (one 20k bank @ 20 W in ≈ **3–4 h**; wall has headroom for phone in parallel — Armor slower at **18 W**).
