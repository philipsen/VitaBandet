# Companion plan — Grövelsjön → Storlien · Feb 2027
...
| **Ski** | **Grövelsjön → Storlien** · **~162 km** · **D1–D10** |
| **Dates** | Arrive **13–14 Feb** · ski **15–24 Feb** · home **~25–27 Feb** |
| **Mode** | Ski + **own pulk** · **one shared tent** · **one shared stove** |
| **After Storlien** | **Night in Storlien** · morning train → **Mora** → drive car **NL** |
| **You** | Continue Bandet solo from **D11** (keep tent + stove) |

```text
NL ──(shared drive)──► Mora (park)
                          │
                          ├── 396 bus ──► Grövelsjön (both)
                          │                    │
                          │                    └── ski D1–D10 ──► Storlien (24 Feb)
                          │                                          │
                          │                     companion ◄── train ─┘
                          │                            │
                          └◄──── drive car to NL ──────┘
...
| **25 Feb** (or 26) | **Morning train** → Mora · collect car |
| **25–27 Feb** | Drive Mora → NL |

**Slack:** weather may delay Storlien by **1–2 days** — keep train/car flexible · parking booked **through ~28 Feb**. If you cannot drive the car home, tell the skier ASAP so Mora parking can extend to **late Apr** (see transport **Case 2**).

---

## Day-by-day (companion view)

Same camps as main plan. Distances from [dag-for-dag](./dag-for-dag-2027.md).
...
| **8** | Mon 22 Feb | 20 | Sylarna area | STF closed — **T** |
...
**Shared (your Bandet kit stays with you after Storlien):** **one tent** · **one stove** · alkylate bottles · nav / inReach.

Companion brings personal ski/pulk/sleep/clothes — **not** a second tent or stove.
...
**Do not pack:** second tent · second stove · duplicate cookset (unless tiny mug/bowl only).
...
## Exit — Storlien → Mora → NL

### Storlien (D10 / 24 Feb)

Night in Storlien after the ski day. Morning train the next day toward Mora.

- Book **H**: STF Storliens fjällgård / hotel · or Högfjällshotell  
- Shower · dry kit · pack pulk for **train** (soft bag)  
- Confirm **morning SJ / Norrtåg** Storlien → Östersund → Mora  
- **Vasalopps** week starts ~**20 Feb** — Mora busy **after** you ski; companion return **25–27 Feb** may hit crowds — book train early

You keep the **shared tent and stove** and continue solo **D11**. Companion leaves with personal kit only.

### Train

| | Notes |
|--|-------|
| From | **Storlien** station |
| Toward | **Östersund** then **Mora** (check connections — often **not** one seat) |
| Time | Budget **full travel day** |
| Luggage | Ski bag + packed pulk · fees possible |
| Ticket | [SJ](https://www.sj.se/) · flexible if storm-delayed |

### Car

| | Notes |
|--|-------|
| Collect | Mora parking spot · keys + insurance as driver |
| Drive | Mora → NL · winter · **1–2 nights** on road |
| Check-in | Message you on inReach / agreed contact when car is moving |

**Bail options (before Storlien):** Funäsdalen / Tänndalen road · bus toward Mora · skip remaining ski days if injured/weather — car still recoverable.

---

## Money & admin (companion)

- [ ] Named on car **insurance** for SE + return drive  
- [ ] Keys + spare + parking address written  
- [ ] Emergency contacts (yours + theirs)  
...
## Packing checklist — companion

### Travel (NL → Mora → Grövelsjön)

- [ ] Winter driving kit · ferry/bridge booked if needed  
- [ ] Ski bag · pulk packed for **396** hold (or taxi)  
- [ ] **No fuel on bus**  
- [ ] Night Grövelsjön booked  

### On trail (D1–D10)

- [ ] Personal winter kit **without** tent/stove (see gear table)  
- [ ] Food D1–D4 + cash for Hamra Livs  
- [ ] GPX / offline map for §1 only  
- [ ] Shared emergency plan (your inReach)  
- [ ] Bowl/mug/spoon only — cook on shared stove  

### Exit bag (in car or posted to Storlien)

- [ ] Drive-home clothes · shoes  
- [ ] Phone chargers · snacks for long drive  
- [ ] Morning train ticket Storlien → Mora (or buy in Storlien)  
...
### A — Grövelsjön → Storlien (working · D1–D10)

See tables above. **PT:** Dalatrafik **396** Mora → Grövelsjön · **SJ / Norrtåg** Storlien → Östersund → Mora.

| Night | Place | Hut? |
|-------|-------|------|
| Before D1 | Grövelsjön | **STF Grövelsjön** / Sjöstugan |
| D1 | Hävlingestugorna | **Länsstyrelsen** — 4- and 6-bed cabins · stugvärd mid-Feb–end Apr · sauna · book Länsstyrelsen (not STF) |
| D2 | Rogen | **STF Rogen closed** 16 Feb (2026 winter from ~27 Feb) — tent |
| D3 | Skedbrosjön | Tent |
| D4 | Tänndalen | Village: Tänndalsvallen / Fjällnäs lodges · **STF Skarvruet** (~10 km extra) |
| D5–D6 | Band track / Fältjägaren | Tent (Fältjägaren is a waypoint, not a staffed stay) |
| D7–D9 | Helags / Sylarna / Blåhammaren | **STF closed until 5 Mar 2027** — tent west of stations |
| D10 | Storlien | **STF Storliens fjällgård** / Högfjällshotell |

### B — Hemavan → Ammarnäs (★ hut · ~5–6 days)

Southern **Kungsleden**. Matches the Band line (optional **~7 km E** into Ammarnäs on D39). STF winter on this chain is typically **late Feb → early May** (Viterskalet 2026: **27 Feb – 3 May**) — **open** at your Mar pass.

**PT in:** Länstrafiken Västerbotten **31** Umeå → Hemavan (daily) · or **Hemavan Tärnaby Airport** (Arlanda, ~2 h) · local **320** Hemavan–Tärnaby. [tabussen.nu](https://www.tabussen.nu/) · [visithemavantarnaby.se](https://visithemavantarnaby.se/en/resa-hit/).  
**PT out:** **341** Ammarnäs → Sorsele (~75 min, several/day) → Umeå / inland buses. Night in Ammarnäs (STF Wärdshus) then morning bus.

| Night | Place | Hut? |
|-------|-------|------|
| Before | Hemavan | **STF Hemavan** Fjällstation / Fjällcenter |
| D35 | Viterskalet | **STF Viterskalet** · 32 beds · shop · ~11 km from Hemavan |
| D36 | Syter | **STF Syter** ~1 km off track · 28 beds · no shop |
| D37–D38 | Tärnasjön | **STF Tärnasjö** (detour onto staffed hut) or tent on KL west shore |
| D39 | Ammarnäs | **STF Ammarnäs Wärdshus** · or Fritidscenter camping |

**Also on this KL if you stretch days:** **STF Serve** · **STF Aigert** (Aigert has shop). Summer KL is **~78 km / 6 stages**; winter with pulk is the D35–D39 block.

Companion leaves east by bus; you continue **väster om** on Bandet toward Kvikkjokk.

### C — Ritsem → Abisko (★ hut · ~7 days)

Staffed **Kungsleden** from Ritsem. Your dates **10–17 Apr** sit inside typical KL winter windows ([stf-openings](./stf-openings-2027.md)). **Best public-transport exit on the whole Band** (Malmbanan at Abisko).

**PT in:** Night train → **Gällivare** · **Falcks Omnibus** Gällivare → Ritsem (1–2×/day in season) · book bus **with the train ticket** so connections are protected · [roadtoritsem.com](https://roadtoritsem.com/) · +46 970 240 00. Taxi backup Sverigetaxi Gällivare **0970-10 000** (expensive).  
**PT out:** **Abisko Östra / Abisko Turiststation** — SJ night train south (Kiruna / Stockholm).
...
| D61 | Abiskojaure | **STF Abiskojaure** |
| D62 | Abisko | **STF Abisko** year-round · tent site + Keron showers |

Companion can skip Padjelanta and **meet you at Ritsem** (bus in the same day you shop). You keep skiing north together to Abisko.
...
| **42** | Tue 23 Mar | 30 | Camp · 820 km | **Long day** — stick together |
| **43–44** | 24–25 Mar | 25+24 | Camps · 845 / 869 km | Tent on KL west / Hornavan ice |
| **45** | Fri 26 Mar | 14 | **Kvikkjokk** · **D** | **STF** · end ski · weekend then Mon bus |

**Hard days:** **D42** (30 km) · ice on Hornavan · thin exit. Hut-heavy only if she **quits at Ammarnäs** (option B, ~5–6 d). Food: buy at Hemavan for the whole leg, or split at Ammarnäs / Jäckvik ICA. Fuel: **max liquid fill at Hemavan** for two on one stove — Kvikkjokk often has no alkylate.
...
**PT in:** Abisko train (easiest gate on the Band).  
**PT out:** no road at the cairn — ski to **Kilpisjärvi** then Matkahuolto buses toward Karesuvanto / Kiruna (fragile Apr timetable — see [transport](./transport-considerations-2027.md)). Tromsø via Signaldalen is the Norway alt.

| Night | Place | Hut? |
|-------|-------|------|
| D63 | Lappjordhytta | **DNT** · key required · **no pantry** |
| D64 | Altevasshytta | DNT |
| D65 | Gaskashytta | DNT |
| D66 | Vuomahytta | DNT |
| D67 | Dividalshytta | DNT |
| D68 | Daertahytta | DNT |
| D69 | Pältastugan | **STF** — 2026 winter ended **19 Apr**; **D69 = 24 Apr** may be **closed** (safety room only) |
| D70 | Treriksröset | Goal · then ski out |

Hut-to-hut if they bring a **DNT key** and **7–8 days food from Abisko**. Finish transport is worse than walking onto a train at Abisko (C).

### G — Tänndalen → Storlien (short join onto A)

Companion skips Grövelsjön and meets you at **Hamra Livs (D4)**. **PT in:** Härjedalingen / Länstrafiken to **Funäsdalen** · winter ski bus to Tänndalen · Snälltåget + Östersund transfer (selected days). **PT out:** Storlien train (same as A).
...
| A **plus Klaartje on D** (or another later friend on B, C, **H**, **J**, **I**, or **L**) | First companion still takes the car; Klaartje is train/bus only |
